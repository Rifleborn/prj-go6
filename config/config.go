...
func GetConfiguration() Configuration {
	return Configuration{
		...
		DatabaseHost:        getOrDefault("DB_HOST", "localhost:5432"),
		...
		MigrationLocation:   getOrDefault("MIGRATION_LOCATION", "C:/Projects/todo-gr6-go/internal/infra/database/migrations"),
